...
# Heading
Label(root, text="Welcome to Prakhar Travels",font="comicsams 13 bold",pady=15).grid(row=0, column=3)
...
# Button & paciking it and assigning it a command
Button(text="Submit to Prakhar Travels", command=getvals).grid(row=7, column=3)
